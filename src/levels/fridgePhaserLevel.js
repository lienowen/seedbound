...
const ITEM_LIBRARY = {
  ...
  jam: { image: "jam", file: "jar-strawberry.png", name: "Geleia de Morango", tags: ["jar"], size: [1, 1], scale: scaleFromVisibleHeight("jam", 116), anchor: [renderProfile("jam").originX, renderProfile("jam").originY], surface: renderProfile("jam"), bounds: { w: 71, h: 116 }, prefs: { zone: "shelf", likesNeighbors: ["honey", "peanut"] } },
  honey: { image: "honey", file: "jar-orange.png", name: "Geleia de Laranja", tags: ["jar"], size: [1, 1], scale: scaleFromVisibleHeight("honey", 116), anchor: [renderProfile("honey").originX, renderProfile("honey").originY], surface: renderProfile("honey"), bounds: { w: 67, h: 116 }, prefs: { zone: "shelf", likesNeighbors: ["jam", "peanut"] } },
  coffee: { image: "coffee", file: "can-tomato.png", name: "Tomate Pelado", tags: ["can"], size: [1, 1], scale: scaleFromVisibleHeight("coffee", 122), anchor: [renderProfile("coffee").originX, renderProfile("coffee").originY], surface: renderProfile("coffee"), bounds: { w: 95, h: 122 }, prefs: { zone: "shelf", likesNeighbors: ["beans"] } },
  beans: { image: "beans", file: "can-corn.png", name: "Milho", tags: ["can"], size: [1, 1], scale: scaleFromVisibleHeight("beans", 108), anchor: [renderProfile("beans").originX, renderProfile("beans").originY], surface: renderProfile("beans"), bounds: { w: 68, h: 108 }, prefs: { zone: "shelf", likesNeighbors: ["coffee"] } },
  peanut: { image: "peanut", file: "jar-peanut.png", name: "Pasta de Amendoim", tags: ["jar"], size: [1, 1], scale: scaleFromVisibleHeight("peanut", 116), anchor: [renderProfile("peanut").originX, renderProfile("peanut").originY], surface: renderProfile("peanut"), bounds: { w: 64, h: 116 }, prefs: { zone: "shelf", likesNeighbors: ["jam", "honey"] } },
  chips: { image: "chips", file: "box-cereal.png", name: "Cereal", tags: ["box"], size: [1, 1], scale: scaleFromVisibleHeight("chips", 132), anchor: [renderProfile("chips").originX, renderProfile("chips").originY], surface: renderProfile("chips"), bounds: { w: 94, h: 132 }, prefs: { zone: "shelf", likesVisible: true } },
  // ---- New hand-drawn dry-goods (own keys, real art) ----
  "jar-choco": { image: "jar-choco", file: "jar-choco.png", name: "Creme de Avela", tags: ["jar"], size: [1, 1], scale: scaleFromVisibleHeight("jar-choco", 116), anchor: [renderProfile("jar-choco").originX, renderProfile("jar-choco").originY], surface: renderProfile("jar-choco"), bounds: { w: 72, h: 116 }, prefs: { zone: "shelf", likesNeighbors: ["jam", "honey"] } },
  "can-peas": { image: "can-peas", file: "can-peas.png", name: "Ervilha", tags: ["can"], size: [1, 1], scale: scaleFromVisibleHeight("can-peas", 116), anchor: [renderProfile("can-peas").originX, renderProfile("can-peas").originY], surface: renderProfile("can-peas"), bounds: { w: 72, h: 116 }, prefs: { zone: "shelf", likesNeighbors: ["coffee", "beans"] } },
  "can-tuna": { image: "can-tuna", file: "can-tuna.png", name: "Atum", tags: ["can"], size: [1, 1], scale: scaleFromVisibleHeight("can-tuna", 92), anchor: [renderProfile("can-tuna").originX, renderProfile("can-tuna").originY], surface: renderProfile("can-tuna"), bounds: { w: 78, h: 92 }, prefs: { zone: "shelf", likesNeighbors: ["can-peas"] } },
  "box-pasta": { image: "box-pasta", file: "box-pasta.png", name: "Macarrao", tags: ["box"], size: [1, 1], scale: scaleFromVisibleHeight("box-pasta", 140), anchor: [renderProfile("box-pasta").originX, renderProfile("box-pasta").originY], surface: renderProfile("box-pasta"), bounds: { w: 102, h: 140 }, prefs: { zone: "shelf", likesVisible: true } },

...
const ITEM_LIBRARY = {
  ...
  bread: { image: "bread", file: "bread.webp", name: "Pao", tags: ["food"], size: [2, 1], scale: scaleFromVisibleHeight("bread", 96), anchor: [renderProfile("bread").originX, renderProfile("bread").originY], surface: renderProfile("bread"), bounds: { w: 166, h: 96 }, prefs: { zone: "shelf", needsCold: false, likesNeighbors: ["butter", "cheese"] } },
  cheese: { image: "cheese", file: "cheese.webp", name: "Queijo", tags: ["dairy"], size: [1, 1], scale: scaleFromVisibleHeight("cheese", 100), anchor: [renderProfile("cheese").originX, renderProfile("cheese").originY], surface: renderProfile("cheese"), bounds: { w: 100, h: 100 }, prefs: { zone: "shelf", needsCold: true, likesNeighbors: ["butter", "bread"] } },
  ...
  tomato: { image: "tomato", file: "tomato.webp", name: "Tomate", tags: ["food"], size: [1, 1], scale: scaleFromVisibleHeight("tomato", 104), anchor: [renderProfile("tomato").originX, renderProfile("tomato").originY], surface: renderProfile("tomato"), bounds: { w: 100, h: 104 }, prefs: { zone: "drawer", needsCold: false, likesNeighbors: ["apple", "lettuce"] } },
  ...
  watermelon: { image: "watermelon", file: "watermelon.webp", name: "Melancia", tags: ["food"], size: [2, 1], scale: scaleFromVisibleHeight("watermelon", 116), anchor: [renderProfile("watermelon").originX, renderProfile("watermelon").originY], surface: renderProfile("watermelon"), bounds: { w: 124, h: 116 }, prefs: { zone: "shelf", needsCold: false, likesVisible: true } },
